<%-- 
    ...
    Created on : 31 oct 2023, 11:54:24
    Author     : JORGE
--%>
...
<body>
    <div class="card">
        <form id="loginForm" method="post" accept-charset="UTF-8" onsubmit="enviarFormulario(event)">
            <h1 class="titulo"><i class="fas fa-user-secret icono"></i>Iniciar Sesión Administrador</h1>
            ...
            <div id="captchaContainer" class="form-group">
                ...
                <div id="captcha" style="display: flex;">
    ...
    <script>
        ...
        function enviarFormulario(event) {
            ...
            if (captchaIngresado === captchaGenerado) {
                ...
                var nivelRequerido = "Administrador"; // Puedes ajustar esto según tu necesidad
